...
function getPaths(context) {
    ...
    if (context.type === 'user') {
        ...
        iosProjectDirectory = path_1.default.join(context.data.projectPath, 'ios');
        supportingDirectory = path_1.default.join(iosProjectDirectory, projectName, 'Supporting');
    }
    else if (context.type === 'service') {
        projectRootDirectory = path_1.default.dirname(context.build.ios.workspaceSourcePath);
    ...
    const intermediatesDirectory = path_1.default.join(iosProjectDirectory, context.build.isExpoClientBuild() ? 'ExponentIntermediates' : 'ExpoKitIntermediates');
    return {
