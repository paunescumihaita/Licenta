...
class Parser {
    ...
    parse(text) {
        ...
        return switchRegex_1.switchRegex(text, [
            [Matchers_1.Matchers.ANALYZE_MATCHER, ([, $1, $2, $3, $4]) => formatter.formatAnalyze($2, $1, $3, $4)],
            [Matchers_1.Matchers.BUILD_TARGET_MATCHER, ([, $1, $2, $3]) => formatter.formatBuildTarget($1, $2, $3)],
            [
                Matchers_1.Matchers.AGGREGATE_TARGET_MATCHER,
                ([, $1, $2, $3]) => formatter.formatAggregateTarget($1, $2, $3),
            ],
            [
                Matchers_1.Matchers.ANALYZE_TARGET_MATCHER,
                ([, $1, $2, $3]) => formatter.formatAnalyzeTarget($1, $2, $3),
            ],
            [Matchers_1.Matchers.CLEAN_REMOVE_MATCHER, ([$0]) => formatter.formatCleanRemove($0)],
            [Matchers_1.Matchers.CLEAN_TARGET_MATCHER, ([, $1, $2, $3]) => formatter.formatCleanTarget($1, $2, $3)],
            [
                Matchers_1.Matchers.COPY_STRINGS_MATCHER,
                ([, $1, $2, $3]) => formatter.formatCopyStringsFile($1, $2, $3),
            ],
            ...
            [
                ...
                ([, $1, $2, $3, $4]) => formatter.formatCodesign($2, $1, $3, $4),
            ],
            [Matchers_1.Matchers.CODESIGN_MATCHER, ([, $1, $2, $3, $4]) => formatter.formatCodesign($2, $1, $3, $4)],
            ...
            [Matchers_1.Matchers.COMPILE_MATCHER, ([, $1, $2, $3, $4]) => formatter.formatCompile($2, $1, $3, $4)],
            ...
            [
                ...
                ([, $1, $2, $3, $4]) => formatter.formatCompileXib($2, $1, $3, $4),
            ],
            [
                Matchers_1.Matchers.COMPILE_STORYBOARD_MATCHER,
                ([, $1, $2, $3, $4]) => formatter.formatCompileStoryboard($2, $1, $3, $4),
            ],
            [Matchers_1.Matchers.COPY_HEADER_MATCHER, ([, $1, $2]) => formatter.formatCopyHeaderFile($1, $2)],
            [Matchers_1.Matchers.COPY_PLIST_MATCHER, ([, $1, $2]) => formatter.formatCopyPlistFile($1, $2)],
            [Matchers_1.Matchers.CPRESOURCE_MATCHER, ([, $1]) => formatter.formatCpresource($1)],
            ...
            [
                ...
                ([, $1, $2, $3]) => formatter.formatGenerateDsym($1, $2, $3),
            ],
            [
            ...
            [Matchers_1.Matchers.LIBTOOL_MATCHER, ([, $1, $2, $3]) => formatter.formatLibtool($1, $2, $3)],
            [
                Matchers_1.Matchers.LINKING_MATCHER,
                ([, $1, $2, $3, $4, $5]) => formatter.formatLinking($1, $2, $3, $4, $5),
            ],
            ...
            [
                ...
                // @ts-ignore: spread
                ([, $1, $2, $3, $4]) => formatter.formatProcessInfoPlist(...unescaped([$2, $1]), $3, $4),
            ],
            [
            ...
            [Matchers_1.Matchers.PHASE_SUCCESS_MATCHER, ([, $1]) => formatter.formatPhaseSuccess($1)],
            [
                Matchers_1.Matchers.PROCESS_PCH_MATCHER,
                ([, $1, $2, $3]) => formatter.formatProcessPch(path_1.basename($1), $1, $2, $3),
            ],
            ...
            [Matchers_1.Matchers.TOUCH_MATCHER, ([, $1, $2]) => formatter.formatTouch($1, $2)],
