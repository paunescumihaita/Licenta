...
function updatePackageJSONDependencies({
  ...
  for (const dependenciesKey of requiredDependencies) {
    ...
    (_pkg$dependencies = pkg.dependencies) === null || _pkg$dependencies === void 0 ? void 0 : _pkg$dependencies[dependenciesKey]) {
...
function updatePackageJSONScripts({
  ...
  if (!((_pkg$scripts$start = pkg.scripts.start) === null || _pkg$scripts$start === void 0 ? void 0 : _pkg$scripts$start.includes('--dev-client'))) {
    pkg.scripts.start = 'react-native start';
  }

  if (!((_pkg$scripts$android = pkg.scripts.android) === null || _pkg$scripts$android === void 0 ? void 0 : _pkg$scripts$android.includes('run'))) {
    pkg.scripts.android = 'react-native run-android';
  }

  if (!((_pkg$scripts$ios = pkg.scripts.ios) === null || _pkg$scripts$ios === void 0 ? void 0 : _pkg$scripts$ios.includes('run'))) {
